...
**Note: The `carla_dataset.py` file provides a sample PyTorch API for a dataset generated by SimBEV. For more information, see [this](https://github.com/GoodarzMehr/bevfusion) implementation of BEVFusion using a dataset generated by SimBEV.**
