...
## News
**[2026/7/28]** [SimBEV2X](https://github.com/GoodarzMehr/SimBEV2X), a Vehicle-to-Everything (V2X) data generation tool and dataset based on SimBEV, is released.
...
3D object detection benchmarks were revised after becoming aware of a flaw ([#14](https://github.com/GoodarzMehr/SimBEV/issues/14)) in our evaluation method thanks to [@qinlong2133](https://github.com/qinlong2133). The original benchmarks are provided at the end for reference.
